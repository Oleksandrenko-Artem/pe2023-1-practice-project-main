...
class Header extends React.Component {
  ...
  componentDidMount() {
    ...
    this.updateDueEventsCount();
    window.addEventListener(
      'contest-events-updated',
      this.updateDueEventsCount
    );
  ...
  updateDueEventsCount = () => {
    this.setState({ dueEventsCount: getDueEventsCount() });
  };
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      {this.state.dueEventsCount > 0 && (
                        <span className={styles.eventBadge}>
                          {this.state.dueEventsCount}
                        </span>
                      )}
                    </li>
                    <li>
